    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="10" class="px-4 py-8 text-center text-sm text-gray-500 border border-gray-300">
                            Tidak ada data
                        </td>
                    </tr>
                @endforelse
            ...
            @if($records->total() > 0)
                <tfoot class="bg-gray-100 font-semibold">
                    <tr class="bg-gray-200">
                        <td colspan="3" class="px-4 py-3 text-sm text-gray-900 border border-gray-300 font-bold">Jumlah</td>
                    ...
                    <tr class="bg-gray-100">
                        <td colspan="3" class="px-4 py-3 text-sm text-gray-900 border border-gray-300 font-bold">Rata-Rata</td>
                    ...
                    <tr class="bg-gray-200">
                        <td colspan="3" class="px-4 py-3 text-sm text-gray-900 border border-gray-300 font-bold">Maximum</td>
