    ...
    <x-slot name="header">
        <div class="relative bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 text-white py-8">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <h2 class="mt-2 text-3xl font-bold">{{ __('Laporan Pelabuhan BPTD Kelas II Bali') }}</h2>
                <p class="mt-2 text-blue-100">Catat aktivitas operasional pelabuhan harian</p>
            </div>
        </div>
    </x-slot>
